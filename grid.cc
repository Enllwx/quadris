...
//int Grid::getScore(){ return score.getScore(); }
//int Grid::getHighScore(){ return score.getHighScore(); }
...
//    cout << "Current = (" << b.getRow() << ", " << b.getCol() << ")" << endl;
//}
...
void Grid::updateBoard(){
    ...
    if (showHint){
        //cout << "lalalallalalallalalallalalallalalallalalal" << endl;
        Block hintBlock = this->getHint();
        //cout << "hahahahahahahahahahahhahahahaha" << endl;
